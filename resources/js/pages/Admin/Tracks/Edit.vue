...
const imagePreview = ref<string | null>(props.track.cover_image ? `/storage/${props.track.cover_image}` : null);
...
const submit = () => {
    form.post(`/admin/tracks/${props.track.id}`, {
        onSuccess: () => {
            ...
            if (audioPreview.value && !audioPreview.value.startsWith('/storage/')) {
                URL.revokeObjectURL(audioPreview.value);
            }
            if (imagePreview.value && !imagePreview.value.startsWith('/storage/')) {
                URL.revokeObjectURL(imagePreview.value);
                    ...
                    <CardContent class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-gray-500 mb-2">
                                Current Duration: {{ formatDuration(track.duration) }}
                            </p>
                        ...
                        <div class="space-y-2">
                            ...
                            <div v-if="track.cover_image" class="mb-4">
                                <p class="text-sm mb-2">Current Cover:</p>
                                <img :src="`/storage/${track.cover_image}`" alt="Current cover" class="max-w-xs rounded-md" />
                            </div>
                            ...
                            <div v-if="imagePreview && imagePreview !== `/storage/${track.cover_image}`" class="mt-4">
                                <p class="text-sm mb-2">New Cover Preview:</p>
